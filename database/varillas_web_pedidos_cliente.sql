...
CREATE TABLE `pedidos_cliente` (
  ...
  `estado` varchar(20) NOT NULL DEFAULT 'PEDIDO CREADO',
...
INSERT INTO `pedidos_cliente` VALUES (1,'2023-04-20 16:51:02','2023-04-22','SOLICITADO','50475439F','Raul',876584756,'raul.prueba@prueba.com',13.37);
